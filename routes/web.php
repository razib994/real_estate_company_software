...
Route::prefix('admin')->group(function () {
    ...
    Route::resource('contacts', 'ContactController',['name','admin.contacts']);
    ...
    Route::get('/profession/{id}/{start_date}/{end_date}',[
     ...
     Route::get('export-excel-visitor',[
        'as' => 'admin.export-excel-visitor',
        'uses' => 'VisitorsController@exportIntoEXCEL'
    ]);
    ...
    Route::get('/contact/{id}/{start_date}/{end_date}',[
        'as' => 'admin.contact',
        'uses' => 'ContactController@createPDF'
    ]);
    Route::get('/particulars-pdf/{id}/{particular_id}/{start_date}/{end_date}',[
        'as' => 'admin.particulars-pdf',
        'uses' => 'ProjectPaymentController@createindivisualPDF'
    ]);

    //    Head Office particular Mange Information
    Route::get('/create-headoffice-particular', [
        'uses' => 'HeadOfficeController@create',
        'as'   => 'create-headoffice-particular'
    ]);

    Route::get('/manage-headoffice-particular', [
        'uses' => 'HeadOfficeController@index',
        'as'   => 'manage-headoffice-particular'
    ]);

    Route::post('/new-headoffice-particular', [
        'uses' => 'HeadOfficeController@store',
        'as'   => 'new-headoffice-particular'
    ]);

    Route::get('/edit-headoffice-particular/{id}', [
        'uses' => 'HeadOfficeController@edit',
        'as'   => 'edit-headoffice-particular'
    ]);

    Route::post('/update-headoffice-particular', [
        'uses' => 'HeadOfficeController@update',
        'as'   => 'update-headoffice-particular'
    ]);


    Route::post('/delete-headoffice-particular/{id}', [
        'uses' => 'HeadOfficeController@delete',
        'as'   => 'delete-headoffice-particular'
    ]);

    Route::get('/create-overhead-particular', [
        'uses' => 'HeadOfficeController@overHeadCreate',
        'as'   => 'create-overhead-particular'
    ]);

    Route::get('/manage-overhead-particular', [
        'uses' => 'HeadOfficeController@overHeadManage',
        'as'   => 'manage-overhead-particular'
    ]);
    Route::post('/new-overhead-particular', [
        'uses' => 'HeadOfficeController@storeoverhead',
        'as'   => 'new-overhead-particular'
    ]);
    // head office Project overhead
    Route::get('/create-overhead-project', [
        'uses' => 'OverheadProjectController@overHeadprojectCreate',
        'as'   => 'create-overhead-project'
    ]);

    Route::get('/manage-overhead-project', [
        'uses' => 'OverheadProjectController@overHeadprojectManage',
        'as'   => 'manage-overhead-project'
    ]);
    Route::post('/new-overhead-project', [
        'uses' => 'OverheadProjectController@storeoverheadproject',
        'as'   => 'new-overhead-project'
    ]);
    Route::get('/edit-overhead-project/{id}', [
        'uses' => 'OverheadProjectController@edit',
        'as'   => 'edit-overhead-project'
    ]);

    Route::post('/update-overhead-project', [
        'uses' => 'OverheadProjectController@update',
        'as'   => 'update-overhead-project'
    ]);
    Route::post('/delete-overhead-project/{id}', [
        'uses' => 'OverheadProjectController@delete',
        'as'   => 'delete-overhead-project'
    ]);

    Route::get('/project-overhead-pdf/{start_date}/{end_date}', [
        'uses' => 'OverheadProjectController@createPDF',
        'as'   => 'project-overhead-pdf'
    ]);
        // Overhead
    Route::get('/edit-overhead-expense/{id}', [
        'uses' => 'OverheadController@upateedit',
        'as'   => 'edit-overhead-expense'
    ]);

    Route::post('/update-overhead-expense', [
        'uses' => 'OverheadController@update',
        'as'   => 'update-overhead-expense'
    ]);
    Route::post('/delete-overhead-expense/{id}', [
        'uses' => 'OverheadController@delete',
        'as'   => 'delete-overhead-expense'
    ]);

    Route::get('/project-expense-pdf/{start_date}/{end_date}', [
        'uses' => 'OverheadController@createPDF',
        'as'   => 'project-expense-pdf'
    ]);


    Route::get('admin/visitored', 'VisitorsController@visit',['name','admin.visitored']);
...
//    Route::get('pdf-project-payments', 'ProjectPaymentController@createPDF',['name','admin.pdf-project-payments']);
    ...
    Route::get('projects/{id}/particulars/{particular_id}','ProjectPaymentController@getdetailsParticular')->name('projects.particulars');
    ...
    Route::get('/visitored', 'VisitorsController@visitored')->name('admin.visitored');
