...
class VisitorsController extends Controller
{
    ...
    public function visit(){
        ...
        $dataTable = DB::table('visitors')->select('*');
    ...
    public function store(Request $request)
    {
        ...
        $visitor->contact_id  = $request->contact_id;
    ...
    public function createPDF($start_date, $end_date) {
        ...
        $pdf = PDF::loadView('backend.pages.visitors.pdf', ['visitors'=>$visitors])->setPaper('a4', 'landscape');
        // download PDF file with download method
        return $pdf->stream('visitors.pdf');
    }
    public function visitored(){
        dd("klasdkf");
         }
