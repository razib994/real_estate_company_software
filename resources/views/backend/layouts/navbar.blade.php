            ...
            <div class="text-white py-2 my-0 collapse-inner rounded">
                ...
                @endif
                    ...
                    <a class="collapse-item" href="{{ url('admin/professionals') }}"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Profesion List </a>
                        @endif
                         @if(Auth::guard('admin')->user()->can('visitor.create'))
                <a class="collapse-item" href="{{ url('admin/contacts/create') }}"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Contact Person Add </a>
                @endif
                    @if(Auth::guard('admin')->user()->can('visitor.view'))
                    <a class="collapse-item" href="{{ url('admin/contacts') }}"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Contact Person List </a>
                        @endif
            </div>
        </div>
    </li>
...
{{--             <a class="collapse-item" href="{{ url('admin/payment-report') }}"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Payment Report </a>--}}
    ...
    <!-- Nav Item - Pages Collapse Menu -->
    <li class="nav-item" style="border-bottom: 1px solid rgba(255,255,255, 0.2);">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#head"
           aria-expanded="true" aria-controls="collapsePages">
            <i class="fas fa-fw fa-folder"></i>
            <span> Head Office Information </span>
        </a>
        <div id="head" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="text-white py-2 my-0 collapse-inner rounded">
                @if(Auth::guard('admin')->user()->can('client.create'))
                    <a class="collapse-item" href="{{ route('create-headoffice-particular') }}"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Add Particular </a>
                @endif
                @if(Auth::guard('admin')->user()->can('client.view'))
                    <a class="collapse-item" href="{{ route('manage-headoffice-particular') }}"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> List Particular </a>
                @endif
                    @if(Auth::guard('admin')->user()->can('client.create'))
                        <a class="collapse-item" href="{{ route('create-overhead-particular') }}"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Add Head Office Expense </a>
                    @endif
                    @if(Auth::guard('admin')->user()->can('client.view'))
                        <a class="collapse-item" href="{{ route('manage-overhead-particular') }}"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> List Head Office Expense </a>
                    @endif
                    @if(Auth::guard('admin')->user()->can('client.create'))
                        <a class="collapse-item" href="{{ route('create-overhead-project') }}"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Add OverHead Project </a>
                    @endif
                    @if(Auth::guard('admin')->user()->can('client.view'))
                        <a class="collapse-item" href="{{ route('manage-overhead-project') }}"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> List OverHead Project </a>
                    @endif
            </div>
        </div>
    </li>
