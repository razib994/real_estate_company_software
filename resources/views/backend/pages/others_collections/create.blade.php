...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">  Create Other Amount </h1>
            @if(Auth::guard('admin')->user()->can('cash.view'))
            <a href="{{ route('admin.others_collection_index') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                    class="fas fa-eye fa-sm text-white-50"></i> Other Amount List </a>
                @endif
        </div>
        <!-- DataTales Example -->
            ...
            <div class="card-body">
                ...
                <form action="{{route('admin.store')}}" method="post">
                    ...
                    <div class="form-group row">
                        <label for="purpose_name" class="col-sm-3 col-form-label"> Other Amount Collection </label>
                        <div class="col-sm-6">
