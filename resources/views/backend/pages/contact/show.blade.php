...
@section('title')
    {{ $contact->person_name }} Visitors List
@endsection
@section('content')
    <style>
        th {
    ...
    <!-- Page Heading -->
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">{{ $contact->person_name }} Visitors List </h1>
            ...
            @endif
            <form action="{{url('admin/contact-view',$contact->id)}}"  method="get">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-2 text-right">
                ...
                <a href="{{route('admin.contact',[$contact->id,$start_date, $end_date])}}" class="btn btn-light btn-sm border"><i class="fas fa-file-pdf text-danger" aria-hidden="true"></i> PDF</a>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary"> {{ $contact->person_name  }} Visitors List </h6>
            </div>
            <div class="card-body">
