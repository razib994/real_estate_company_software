                        ...
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" border="1">
                            ...
                            <tr>
                                ...
                                <th class="text-right">
                                    @php
                                        if($today != $start_date){
                                        echo number_format($overs = \App\HeadOfficeOverhead::where('payment_method','cash')->whereBetween('date',[$start_date,$end_date])->sum('amount'),2);
                                        } else {
                                        echo number_format($overs = \App\HeadOfficeOverhead::where('payment_method','cash')->sum('amount'),2);
                                        } @endphp
                                </th>
                                <!--<th> </th>-->
                            </tr>
                            <tr>
                                ...
                                <th style="text-align: right;"> {{ number_format(($pro_t_amount+$overs),2) }} </th>
                                <!--<th> </th>-->
                            </tr>
