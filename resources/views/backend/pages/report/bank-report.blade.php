                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                <?php $total = 0; $to = 0; $final =0; $fin=''; $ck=''; $ca=''; $overs='';
                                ...
                                @php
                                if($today != $start_date){
                                echo number_format($overs = \App\HeadOfficeOverhead::where('bank_id',$banks->id)->where('payment_method','check')->whereBetween('date',[$start_date,$end_date])->sum('amount'),2);
                                } else {
                                echo number_format($overs = \App\HeadOfficeOverhead::where('bank_id',$banks->id)->where('payment_method','check')->sum('amount'),2);
                                } @endphp
                                    </th>
                                </tr>
                                </tbody>
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: right!important;"> {{ number_format(($pro_t_amount+$overs),2) }} </th>
                                </tr>
