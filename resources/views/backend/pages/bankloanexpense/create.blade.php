...
@section('title')
    Bank Loan Refund Create
@endsection
@section('content')
    <div class="container-fluid">
        <!-- Page Heading -->
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">  Create Bank  Loan Refund </h1>
            ...
            <a href="{{ route('bankloanex.bankloanexpense', $bankloans->id) }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                    class="fas fa-eye fa-sm text-white-50"></i> Bank Loan Refund  List </a>
                @endif
        </div>
        <!-- DataTales Example -->
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                @endif
                <form action="{{route('bankloanex.stored',$bankloans->id)}}" method="post">
                    @csrf
