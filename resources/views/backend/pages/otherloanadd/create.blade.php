...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="{{ route('othersloan.loanadd', $othersloans->id) }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary"> Loan Create </h6>
            </div>
            <div class="card-body">
                @if ($errors->any())
                ...
                @endif
                <form action="{{route('othersloan.stored',$othersloans->id)}}" method="post">
                    @csrf
