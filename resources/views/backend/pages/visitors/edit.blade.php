            ...
            <div class="card-body">
                ...
                <form action="{{route('visitors.update', $visitors->id)}}" method="post" enctype='multipart/form-data'>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control" value="{{$visitors->road}}" id="road" name="road" placeholder="Enter Front Road"/>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="story" class="col-sm-3 col-form-label">Storied</label>
                        <div class="col-sm-6">
                            <textarea class="form-control" id="store" name="store" placeholder="Enter Your Storied">{{$visitors->store}}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <select class="form-control" name="contact_id">
                                <option value="0" selected disabled> Enter Your Contact Person Setting </option>
                                @php $contact = \App\Contact::all() @endphp
                                @foreach($contact as $pros)
                                    <option value="{{ $pros->id }}" @if($visitors->contact_id==$pros->id) selected @endif> {{ $pros->person_name }} </option>
                                @endforeach
                            </select>
                        </div>
                    </div>
