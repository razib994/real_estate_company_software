...
@section('title')
    Invest Money Expense
@endsection
@section('content')
    <div class="container-fluid">
        <!-- Page Heading -->
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">  Create Invest Money Expense</h1>
            @if(Auth::guard('admin')->user()->can('bank.view'))
            <a href="" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                    class="fas fa-eye fa-sm text-white-50"></i> Invest Money Expense List </a>
                @endif
        </div>
        <!-- DataTales Example -->
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                @endif
                <form action="{{route('investmoneysd.stored',$invest->id)}}" method="post">
                    @csrf
