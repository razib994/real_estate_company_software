...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <form action="{{ route('manage-overhead-project') }}"  method="get">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-2 text-right">
                ...
                <a href="{{ route('project-overhead-pdf',[$start_date, $end_date]) }}" class="btn btn-light btn-sm border"><i class="fas fa-file-pdf text-danger" aria-hidden="true"></i> PDF</a>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Head office overhead Project Amount   </h6>
            </div>
            @php
                $today =  date("Y-m-d");
$fi_to=0; $to='';
...
{{--                                    {{ $pro->project_name  }}--}}
                                ...
                                <td>
                                    <form action="{{route('delete-overhead-project', ['id' => $overheadproject->id])}}" method="POST">
                                        <a href="{{route('edit-overhead-project', ['id' => $overheadproject->id]) }}" class="btn btn-success btn-sm"> <i class="fa fa-edit"></i> </a>
                                        @csrf

                                        <button type="submit" onclick="return confirm('Are You Sure Deleted This Item!');" class="btn btn-danger btn-sm"> <i class="fa fa-trash"></i> </button>
                                    </form>
                                </td>
                            </tr>
                        @endforeach
